...
INSERT INTO `CQ1_4_quote` 			(SELECT `service_id`, `id`, `post_ip`, `post_date`, `quote`, `quote`, `source`, `context`, `explanation`, `explanation`, `author`, `publisher`, `publisher_info`, `mail`, `site`, `category`, `vote_up`, `vote_down`, `comments`, null, `signatures`, `reported`, `quote_state` FROM `CQ1_3_quote`);
INSERT INTO `CQ1_4_history` 		(SELECT `service_id`, '2', `id`, '20', `post_ip`, `post_date`, `publisher`, `mail`, `site`, `quote` FROM `CQ1_4_quote`);
INSERT INTO `CQ1_4_history` 		(SELECT `service_id`, '2', `id`, '21', `post_ip`, `post_date`, `publisher`, `mail`, `site`, `explanation` FROM `CQ1_4_quote`);
...
INSERT INTO `CQ1_4_selection` 		(SELECT `service_id`, `id`, `post_ip`, `post_date`, `name`, null FROM `CQ1_3_selection`);
...
INSERT INTO `CQ1_4_selection_quote` (SELECT `service_id`, `selection_id`, `quote_id` FROM `CQ1_3_selection_quote`);
