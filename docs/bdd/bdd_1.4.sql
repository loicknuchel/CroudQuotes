...
DROP TABLE IF EXISTS `CQ1_4_api_log`;
DROP TABLE IF EXISTS `CQ1_4_suivi`;
DROP TABLE IF EXISTS `CQ1_4_selection_quote`;
DROP TABLE IF EXISTS `CQ1_4_category_quote`;
...
DROP TABLE IF EXISTS `CQ1_4_service`;
DROP TABLE IF EXISTS `CQ1_4_bdd_info`;

CREATE TABLE `CQ1_4_bdd_info` (
	`version` VARCHAR(5) NOT NULL,
	`mise_en_service` timestamp NOT NULL default CURRENT_TIMESTAMP
) ENGINE = MYISAM CHARACTER SET utf8 COLLATE utf8_general_ci;

CREATE TABLE `CQ1_4_service` (
	`id` INT NOT NULL,
...
CREATE TABLE `CQ1_4_id_increment` (
...
ALTER TABLE `CQ1_4_id_increment` ADD CONSTRAINT FK_id_increment_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

CREATE TABLE `CQ1_4_category` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL,
...
ALTER TABLE `CQ1_4_category` ADD CONSTRAINT FK_category_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

CREATE TABLE `CQ1_4_quote` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL,
	`post_ip` INT NOT NULL,
	`post_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
ALTER TABLE `CQ1_4_comment` ADD CONSTRAINT FK_comment_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

/* permet de signer pour un élément */
CREATE TABLE `CQ1_4_petition` (
	`service_id` INT NOT NULL,
...
ALTER TABLE `CQ1_4_selection` ADD CONSTRAINT FK_selection_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

/* ajoute des votes aux quotes */
CREATE TABLE `CQ1_4_vote` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL AUTO_INCREMENT,
	`post_ip` INT NOT NULL,
	`post_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
ALTER TABLE `CQ1_4_vote` ADD CONSTRAINT FK_vote_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);
...
ALTER TABLE `CQ1_4_reported` ADD CONSTRAINT FK_reported_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);
...
CREATE TABLE `CQ1_4_category_quote` (
	`service_id` INT NOT NULL,
	`post_ip` INT NOT NULL,
	`post_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
ALTER TABLE `CQ1_4_category_quote` ADD CONSTRAINT FK_category_quote_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);
ALTER TABLE `CQ1_4_category_quote` ADD CONSTRAINT FK_category_quote_id FOREIGN KEY (`quote_id`) REFERENCES `CQ1_4_quotes`(`id`);
ALTER TABLE `CQ1_4_category_quote` ADD CONSTRAINT FK_category_category_id FOREIGN KEY (`category_id`) REFERENCES `CQ1_4_category`(`id`);
...
ALTER TABLE `CQ1_4_selection_quote` ADD CONSTRAINT FK_selection_quote_id FOREIGN KEY (`quote_id`) REFERENCES `CQ1_4_quotes`(`id`);
ALTER TABLE `CQ1_4_selection_quote` ADD CONSTRAINT FK_selection_selection_id FOREIGN KEY (`selection_id`) REFERENCES `CQ1_4_selection`(`id`);

/* lie une adresse mail à un élément pour le suivre */
CREATE TABLE `CQ1_4_suivi` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL AUTO_INCREMENT,
	`post_ip` INT NOT NULL,
	`post_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
ALTER TABLE `CQ1_4_suivi` ADD CONSTRAINT FK_suivi_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

/* log les appels à l'API */
CREATE TABLE `CQ1_4_api_log` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `CQ1_4_api_log` ADD CONSTRAINT FK_api_log_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

/* log les requêtes effectuées en base ! */
CREATE TABLE `CQ1_4_sqlreq_log` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `CQ1_4_sqlreq_log` ADD CONSTRAINT FK_sqlreq_log_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);
ALTER TABLE `CQ1_4_sqlreq_log` ADD CONSTRAINT FK_sqlreq_log_call_id FOREIGN KEY (`api_log_id`) REFERENCES `CQ1_4_api_log`(`id`);

/* logs de l'application */
CREATE TABLE `CQ1_4_app_log` (
	`service_id` INT NOT NULL,
	`id` INT NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `CQ1_4_app_log` ADD CONSTRAINT FK_app_log_service_id FOREIGN KEY (`service_id`) REFERENCES `CQ1_4_service`(`id`);

/* controle la fréquence d'accès des clés. Indépendant des services... */
CREATE TABLE `CQ1_4_key_cpt` (
