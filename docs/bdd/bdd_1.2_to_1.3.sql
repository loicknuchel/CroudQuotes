...
INSERT INTO `CQ1_3_comment` 		(SELECT `service_id`, `id`, `post_ip`, `post_date`, `elt_type`, `elt_id`, '0', `publisher`, `mail`, `site`, `comment`, `vote_up`, `vote_down`, `reported`, `comment_state` FROM `newCQ_comment`);
